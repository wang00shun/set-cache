...
set SCCACHE_DIR=%PACKAGE_FOLDER%\Rust\sccache
set RUSTC_WRAPPER=%CARGO_HOME%\bin\sccache.exe
md %SCCACHE_DIR%
setx /m SCCACHE_DIR %SCCACHE_DIR%
setx /m RUSTC_WRAPPER %RUSTC_WRAPPER%
